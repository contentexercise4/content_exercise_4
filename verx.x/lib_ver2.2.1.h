...
//ver1
//int WindowWidth = 4320;			//6画面対応
//int WindowHeight = 11520;			//6画面対応

//ver2
//下は普通だが上がやけに広い
//int WindowWidth = 8640;			//6画面対応
//int WindowHeight = 3240;			//6画面対応

//ver3
//左上2つが全く映らなくなった(heightを1/3=2/6減らした)
//int WindowWidth = 8640;			//6画面対応
//int WindowHeight = 2160;			//6画面対応

//ver4
//heightを3240から2700へ(1/6減らした)
//int WindowWidth = 8640;			//6画面対応
//int WindowHeight = 2700;		//6画面対応

//ver5
//widthを1/6減らした
//int WindowWidth = 7200;				//6画面対応
//int WindowHeight = 3240;			//6画面対応

//ver5
//前回の結果, 6面ディスプレイの左1つが1/6映らなくなった。その後紙面上で計算して出た値をwに代入した
//現状これが一番良い。本番環境用
//int WindowWidth = 8214;				//6画面対応
//int WindowHeight = 3240;			//6画面対応

//----------------------------------------------------------------------------------------------------------------
// ここまで
//----------------------------------------------------------------------------------------------------------------
char WindowTitle[] = "TMF_ver2.2.1";			//ウィンドウのタイトル
