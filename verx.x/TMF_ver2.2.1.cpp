...
void Initialize() {
	...
	Texture[20].Load("bmp/gameresult/result2.bmp");
	Texture[21].Load("bmp/gameresult/result3.bmp");
	Texture[22].Load("bmp/gameresult/result4.bmp");
	...
	Texture[23].Load("bmp/time/3_00.bmp");
	...
	Texture[26].Load("bmp/time/2_00_2.bmp");
